...
\CommentTok{# out}
\NormalTok{p %>%}\StringTok{ }\KeywordTok{adezip}\NormalTok{(}\DataTypeTok{type =} \StringTok{"out"}\NormalTok{)}
\CommentTok{# in}
\NormalTok{p %>%}\StringTok{ }\KeywordTok{adezip}\NormalTok{(}\DataTypeTok{type =} \StringTok{"in"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p %>%}\StringTok{ }\KeywordTok{irsa}\NormalTok{()     ->}\StringTok{ }\NormalTok{rsa}
\NormalTok{p %>%}\StringTok{ }\KeywordTok{iano_mco}\NormalTok{() ->}\StringTok{ }\NormalTok{ano_out}
\NormalTok{p %>%}\StringTok{ }\KeywordTok{itra}\NormalTok{()     ->}\StringTok{ }\NormalTok{tra}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{enrobeur}\NormalTok{(li, }\DataTypeTok{robe=}\StringTok{"}\CharTok{\textbackslash{}'}\StringTok{%"}\NormalTok{, }\DataTypeTok{interstice=}\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, }\DataTypeTok{symetrique =} \NormalTok{T) %>%}\StringTok{ }\KeywordTok{cat}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{enrobeur}\NormalTok{(li, }\DataTypeTok{robe=}\StringTok{""}\NormalTok{, }\DataTypeTok{interstice=}\StringTok{"|"}\NormalTok{) %>%}\StringTok{ }\KeywordTok{cat}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{enrobeur}\NormalTok{(li, }\DataTypeTok{robe=}\StringTok{"}\CharTok{\textbackslash{}'}\StringTok{"}\NormalTok{, }\DataTypeTok{interstice=}\StringTok{", "}\NormalTok{) %>%}\StringTok{ }\KeywordTok{cat}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{con <-}\StringTok{ }\NormalTok{MonetDBLite::}\KeywordTok{src_monetdblite}\NormalTok{(dbdir)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{con <-}\StringTok{ }\NormalTok{dplyr::}\KeywordTok{src_sqlite}\NormalTok{(dbdir)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{con <-}\StringTok{ }\NormalTok{dplyr::}\KeywordTok{src_postgres}\NormalTok{(}\DataTypeTok{user =} \StringTok{"gui"}\NormalTok{, }\DataTypeTok{password =} \StringTok{"gui"}\NormalTok{, }\DataTypeTok{dbname =} \StringTok{"aphp"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{purrr::}\KeywordTok{quietly}\NormalTok{(db_mco_out)(con,  p, }\DataTypeTok{annee =} \DecValTok{2016}\NormalTok{) ->}\StringTok{ }\NormalTok{ok }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{DBI::}\KeywordTok{dbDisconnect}\NormalTok{(con$con)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tarifs      <-}\StringTok{ }\NormalTok{nomensland::}\KeywordTok{get_table}\NormalTok{(}\StringTok{'tarifs_mco_ghs'}\NormalTok{) %>%}\StringTok{ }\KeywordTok{distinct}\NormalTok{(ghs, anseqta, }\DataTypeTok{.keep_all =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{supplements <-}\StringTok{ }\NormalTok{nomensland::}\KeywordTok{get_table}\NormalTok{(}\StringTok{'tarifs_mco_supplements'}\NormalTok{) %>%}\StringTok{ }\KeywordTok{mutate_if}\NormalTok{(is.numeric, tidyr::replace_na, }\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{p <-}\StringTok{ }\KeywordTok{noyau_pmeasyr}\NormalTok{(}
  \DataTypeTok{finess   =} \StringTok{'750712184'}\NormalTok{,}
  \DataTypeTok{annee    =} \DecValTok{2000} \NormalTok{+}\StringTok{ }\NormalTok{annee,}
...
\NormalTok{p <-}\StringTok{ }\KeywordTok{noyau_pmeasyr}\NormalTok{(}
  \DataTypeTok{finess   =} \StringTok{'750712184'}\NormalTok{,}
  \DataTypeTok{annee    =} \DecValTok{2000} \NormalTok{+}\StringTok{ }\DecValTok{18}\NormalTok{,}
