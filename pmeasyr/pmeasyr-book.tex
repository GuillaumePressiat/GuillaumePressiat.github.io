...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{age_moyen =} \KeywordTok{mean}\NormalTok{(AGEAN, }\DataTypeTok{na.rm =} \NormalTok{T),}
            \DataTypeTok{dms =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{if_else}\NormalTok{(DUREE>}\DecValTok{0}\NormalTok{, DUREE, }\OtherTok{NA_integer_}\NormalTok{), }\DataTypeTok{na.rm =} \NormalTok{T),}
...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{dms =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{if_else}\NormalTok{(DUREE>}\DecValTok{0}\NormalTok{, DUREE, }\OtherTok{NA_integer_}\NormalTok{), }\DataTypeTok{na.rm =} \NormalTok{T),}
            \DataTypeTok{effectif =} \KeywordTok{n}\NormalTok{())}
\end{Highlighting}
\end{Shaded}
