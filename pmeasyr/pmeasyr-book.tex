...
hors de l'archives, on peut les effacer : c'est ce que permet la
fonction \texttt{adelete()}.
...
\section{Exemple 2 : recherche de codes
actes}\label{exemple-2-recherche-de-codes-actes}
...
\NormalTok{rsa15$rsa %>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{age_moyen =} \KeywordTok{mean}\NormalTok{(AGEAN),}
                        \DataTypeTok{dms =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{if_else}\NormalTok{(DUREE>}\DecValTok{0}\NormalTok{, DUREE, }\OtherTok{NA}\NormalTok{), }\DataTypeTok{na.rm =} \NormalTok{T))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{dms =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{if_else}\NormalTok{(DUREE>}\DecValTok{0}\NormalTok{, DUREE, }\OtherTok{NA}\NormalTok{), }\DataTypeTok{na.rm =} \NormalTok{T))}
\end{Highlighting}
\end{Shaded}
