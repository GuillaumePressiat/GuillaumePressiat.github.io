...
In a pretty old [post](https://guillaumepressiat.github.io/blog/2019/11/oraclyr) on this blog, I write about Oracle database connexion from R on Windows with ODBC when you have old Oracle clients (32 bit version) installed in an enterprise setup.
